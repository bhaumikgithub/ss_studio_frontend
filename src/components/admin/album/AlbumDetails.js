              ...
              <div className="select-delete">
                ...
                {process.env.NODE_ENV === 'development' ? 
                  <a
                    href={
                      album.is_private
                        ? (album && album.domain_name ? album.domain_name : process.env.REACT_APP_API_BASE_URL + this.props.album.user_name) +'/shared_album_login/' + albumSlug
                        : (album && album.domain_name ? album.domain_name : process.env.REACT_APP_API_BASE_URL + this.props.album.user_name) +'/shared_album/' + albumSlug
                    }
                    target="_blank"
